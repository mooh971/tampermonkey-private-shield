...
| هوية وطنية | `1XXXXXXXXX` ، `2XXXXXXXXX` ، `3XXXXXXXXX` |

***

## 🔧 التقنيات المستخدمة

- **Tampermonkey** — منصة تشغيل السكربتات
- **MutationObserver** — لمراقبة التغييرات الديناميكية فوراً
- **Regex** — للكشف الدقيق عن البيانات الحساسة
- `@run-at document-start` — للتشغيل قبل ظهور أي محتوى
